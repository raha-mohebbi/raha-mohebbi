...
- Learning advanced **React patterns**, state management (Redux / Context API), and UI libraries  
...
[![PWA](https://img.shields.io/badge/PWA-5A5A5A?style=for-the-badge)](https://web.dev/progressive-web-apps/)
